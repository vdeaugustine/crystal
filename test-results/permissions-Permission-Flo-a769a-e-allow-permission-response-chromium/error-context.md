...
- Name: Permission Flow >> should handle allow permission response
- Location: /Users/jordanbentley/git/crystal/worktrees/auto-commit-toggle-1/tests/permissions.spec.ts:148:7

# Error details

```
Error: Command failed: git init
fatal: cannot copy '/opt/homebrew/opt/git/share/git-core/templates/info/exclude' to '/private/var/folders/tz/fhf63bv13hx88g77wvxbx22r0000gn/T/crystal-test-1750438447258/.git/info/exclude': File exists
